...
urlpatterns = patterns('app.userprofile.views',
    ...
    url(r'^create_event/$', 'personal_event', name='create_events'),
    url(r'^my-grades/$', 'my_grades', name='my_grades'),
    url(r'^add_interest/(?P<username>[-\.\w]+)/$', 'new_interest', name='new_interest'),
    url(r'^add_hobby/(?P<username>[-\.\w]+)/$', 'new_hobby', name='new_hobby'),
