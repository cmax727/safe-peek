...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PersonalEvent'
        db.delete_table('userprofile_personalevent')

        # Adding field 'Profile.location'
        db.add_column('userprofile_profile', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'PersonalEvent'
        db.create_table('userprofile_personalevent', (
        ...
        db.send_create_signal('userprofile', ['PersonalEvent'])

        # Deleting field 'Profile.location'
        db.delete_column('userprofile_profile', 'location')
