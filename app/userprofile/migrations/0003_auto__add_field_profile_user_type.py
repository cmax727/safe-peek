...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.user_type'
        db.add_column('userprofile_profile', 'user_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.user_type'
        db.delete_column('userprofile_profile', 'user_type')
