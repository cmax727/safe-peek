...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupCommentStatus'
        db.create_table('groups_groupcommentstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.GroupStatus'])),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('groups', ['GroupCommentStatus'])
    ...
    def backwards(self, orm):
        # Deleting model 'GroupCommentStatus'
        db.delete_table('groups_groupcommentstatus')
    ...
    models = {
        ...
        'groups.group': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_groups'", 'to': "orm['auth.User']", 'through': "orm['groups.GroupMembership']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'privacy': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        'groups.groupcommentstatus': {
            'Meta': {'object_name': 'GroupCommentStatus'},
            'comment': ('django.db.models.fields.TextField', [], {}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['groups.GroupStatus']"})
        },
