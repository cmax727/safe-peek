...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('groups_groupmembership', (
        ...
        db.send_create_signal('groups', ['GroupMembership'])


    def backwards(self, orm):
        # Deleting model 'GroupMembership'
        db.delete_table('groups_groupmembership')
    ...
    models = {
        ...
        'groups.group': {
            ...
            'group_members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_groups'", 'symmetrical': 'False', 'through': "orm['groups.GroupMembership']", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
