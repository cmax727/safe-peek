...
urlpatterns = patterns('app.groups.views',
    ...
    url(r'^text/(?P<id>(\d)+)/$', 'update_timeline', {'timeline_type': 'text'}, name='upload_text'),
    url(r'^picture/(?P<id>(\d)+)/$', 'update_timeline', {'timeline_type': 'picture'}, name='upload_picture'),
    url(r'^youtube/(?P<id>(\d)+)/$', 'update_timeline', {'timeline_type': 'youtube'}, name='upload_youtube'),
    url(r'^file/(?P<id>(\d)+)/$', 'update_timeline', {'timeline_type': 'file'}, name='upload_file'),
)
