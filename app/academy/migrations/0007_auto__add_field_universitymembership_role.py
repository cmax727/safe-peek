...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UniversityMembership.role'
        db.add_column('academy_universitymembership', 'role',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UniversityMembership.role'
        db.delete_column('academy_universitymembership', 'role')
