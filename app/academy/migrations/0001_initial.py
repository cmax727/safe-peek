...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Course'
        db.create_table('academy_course', (
        ...
        db.send_create_signal('academy', ['Course'])

        # Adding model 'CourseMembership'
        db.create_table('academy_coursemembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('academy', ['CourseMembership'])


    def backwards(self, orm):
        # Deleting model 'Course'
        db.delete_table('academy_course')

        # Deleting model 'CourseMembership'
        db.delete_table('academy_coursemembership')
