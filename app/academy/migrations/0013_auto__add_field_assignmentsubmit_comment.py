...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentSubmit.comment'
        db.add_column('academy_assignmentsubmit', 'comment',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssignmentSubmit.comment'
        db.delete_column('academy_assignmentsubmit', 'comment')
