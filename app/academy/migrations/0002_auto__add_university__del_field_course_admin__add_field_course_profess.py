...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('academy_university', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('academy', ['University'])

        # Deleting field 'Course.admin'
        db.delete_column('academy_course', 'admin_id')

        # Adding field 'Course.professor'
        db.add_column('academy_course', 'professor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Course.university'
        db.add_column('academy_course', 'university',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['academy.University']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'University'
        db.delete_table('academy_university')


        # User chose to not deal with backwards NULL issues for 'Course.admin'
        raise RuntimeError("Cannot reverse this migration. 'Course.admin' and its values cannot be restored.")
        # Deleting field 'Course.professor'
        db.delete_column('academy_course', 'professor_id')

        # Deleting field 'Course.university'
        db.delete_column('academy_course', 'university_id')
