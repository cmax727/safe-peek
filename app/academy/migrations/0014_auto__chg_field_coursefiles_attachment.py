...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseFiles.attachment'
        db.alter_column('academy_coursefiles', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'CourseFiles.attachment'
        db.alter_column('academy_coursefiles', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100))
