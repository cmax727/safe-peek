...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AssignmentMembership'
        db.delete_table('academy_assignmentmembership')

        # Adding model 'AssignmentSubmit'
        db.create_table('academy_assignmentsubmit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academy.Assignment'])),
        ...
        db.send_create_signal('academy', ['AssignmentSubmit'])


    def backwards(self, orm):
        # Adding model 'AssignmentMembership'
        db.create_table('academy_assignmentmembership', (
            ('grade', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academy.Assignment'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('academy', ['AssignmentMembership'])

        # Deleting model 'AssignmentSubmit'
        db.delete_table('academy_assignmentsubmit')
    ...
    models = {
        ...
        'academy.assignmentsubmit': {
            'Meta': {'object_name': 'AssignmentSubmit'},
