...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Syllabus.description'
        db.add_column('academy_syllabus', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Syllabus.course'
        db.add_column('academy_syllabus', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['academy.Course']),
                      keep_default=False)

        # Adding field 'Syllabus.created_at'
        db.add_column('academy_syllabus', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 23, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Syllabus.description'
        db.delete_column('academy_syllabus', 'description')

        # Deleting field 'Syllabus.course'
        db.delete_column('academy_syllabus', 'course_id')

        # Deleting field 'Syllabus.created_at'
        db.delete_column('academy_syllabus', 'created_at')
