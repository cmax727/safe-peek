...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Timeline.object_id'
        db.alter_column('timelines_timeline', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=datetime.datetime(2012, 11, 20, 0, 0)))

        # Changing field 'Timeline.content_type'
        db.alter_column('timelines_timeline', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2012, 11, 20, 0, 0), to=orm['contenttypes.ContentType']))
